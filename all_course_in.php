...
<?php ?>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="course_details.php"><img class="card-img-top" src="<?php echo "$imageFile"; ?>" style="height: 300px;" alt=""></a>
...
<?php 
   ...
   onMouseOut="this.style.color='#85bb65'" style="{color:green;} :hover { color: skyblue; }; font-size: 25px; font-weight:bold;">Price <?php echo "$price"; ?>$</a></div>
