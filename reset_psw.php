            ...
            <div class="wrapper fadeInDown">
                <div id="formContent">
                    ...
                    <form  action="#" method="POST" name="recover_psw   name="f1" autocomplete="off" onsubmit = "return validation()" >
                        ...
                        <input  type="password" id="email_address" class="form-control" name="password" required autofocus type="text" id="login" type="email" class="fadeIn second" name="password" placeholder="New Password" style="font-size: 15px; justify-content: center; width: 85%; text-align: center; height: auto; padding-bottom: 12px; padding-top: 12px; margin-bottom: 20px; border-style: unset; box-shadow: 1px 1px 1px skyblue; border-color: skyblue; border-radius: 3px; margin-left: 33px;">
                        
                        
                        <input type="submit" value="Reset" name="reset"  type="submit" value="Recover" type="submit"  class="fadeIn fourth" >
                    </form>
...
<?php
    if(isset($_POST["reset"])){
        ...
        if($Email){
            $new_pass = $hash;
            mysqli_query($conn, "UPDATE user_table SET password='$new_pass' WHERE email='$Email'");
