			...
			<div class="wrapper fadeInDown">
				<div id="formContent">
					...
					<form  action="#" name="f1" onsubmit = "return validation()" method = "POST">
						<input type="text" id="login" class="fadeIn second" name="otp" placeholder="Verification Code" style="font-size: 15px; justify-content: center; width: 85%; text-align: center; height: auto; padding-bottom: 12px; padding-top: 12px; margin-bottom: 20px; border-style: unset; box-shadow: 1px 1px 1px skyblue; border-color: skyblue; border-radius: 3px;">
						
						<input type="submit" name="verifyEmail" class="fadeIn fourth" value="Verify">
					</form>
